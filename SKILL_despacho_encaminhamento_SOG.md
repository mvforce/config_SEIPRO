...
2. **Antes de analisar as conclusões ou redigir o despacho**, perguntar: **"Encontrei a Nota Técnica nº [número]/[ano]/GPO/SOG (SEI nº [número]), de [data], sobre [assunto]. Deseja encaminhar esta Nota Técnica à SOG?"** Aguardar confirmação explícita. Caso o usuário diga não, mostrar as demais NTs GPO encontradas ou pedir o número SEI correto e só então prosseguir. Se não houver NT GPO no processo, informar isso e perguntar qual peça deseja encaminhar. Não tomar silêncio como confirmação.
...
1. Depois da validação item a item, apresentar **a íntegra da minuta**, seguida de pergunta específica: "Você confirma esta versão do despacho à SOG, inclusive sua conclusão e os incisos de encaminhamento, ou deseja alterações?" Se houver mudanças, revisar e pedir confirmação novamente.
2. Somente após confirmação expressa do texto, perguntar separadamente: "Deseja que eu crie este despacho no processo pelo SEI-Pro?" Não criar documento pela simples anuência às conclusões da NT ou ao texto apresentado.
